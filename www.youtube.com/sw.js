...
ytcfg.set({
    ...
    "INNERTUBE_CLIENT_VERSION": "2.20221026.05.00",
    "INNERTUBE_CONTEXT": {
        "client": {
            "clientName": "WEB",
    ...
    "INNERTUBE_CONTEXT_CLIENT_VERSION": "2.20221026.05.00",
...
if (self.trustedTypes && self.trustedTypes.createPolicy) {
    const swPolicy = trustedTypes.createPolicy('youtubeServiceWorkerPolicy', {
        createScriptURL: function(ignored) {
            return 'https:\/\/www.youtube.com\/s\/desktop\/f06ee14b\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js';
        }
    });
    importScripts(swPolicy.createScriptURL(''));
} else {
    importScripts('https:\/\/www.youtube.com\/s\/desktop\/f06ee14b\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js');
}