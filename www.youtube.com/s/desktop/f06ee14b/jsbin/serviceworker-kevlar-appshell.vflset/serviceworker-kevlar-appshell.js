...
!z("Android") || Ga();
Ga();
var Ra = z("Safari") && !(Ga() || z("Coast") || z("Opera") || z("Edge") || z("Edg/") || z("OPR") || z("Firefox") || z("FxiOS") || z("Silk") || z("Android")) && !(z("iPhone") && !z("iPod") && !z("iPad") || z("iPad") || z("iPod"));
var Sa = {},
    Ta = null;
...
function eb() {
    return cb || (cb = new fb(null, bb))
}

function gb(a) {
    db(bb);
    var b = a.V;
    b = null == b || $a(b) ? b : "string" === typeof b ? Xa(b) : null;
...
var rb = Object,
    ...
    tb = [];
B(tb, 3);
var ub = sb.call(rb, tb);

function vb(a) {
    if (D(a.m)) throw Error("Cannot mutate an immutable Message");
};
    ...
    switch (typeof a) {
        ...
        case "object":
            if (a && !Array.isArray(a)) {
                ...
                if (a instanceof fb) {
                    const b = a.V;
                    return null == b ? "" : "string" === typeof b ? b : a.V = Va(b)
                }
            }
    }
    return a
...
function Ab(a, b, c, d) {
    if (null != a) {
        if (Array.isArray(a)) a = Bb(a, b, c, void 0 !== d);
        else if (pb(a)) {
            const e = {};
            for (let f in a) e[f] = Ab(a[f], b, c, d);
            a = e
        } else a = b(a, d);
        return a
    }
...
function Bb(a, b, c, d) {
    ...
    c(a, e);
    for (a = 0; a < e.length; a++) e[a] = Ab(e[a], b, c, d);
    return e
}

function Cb(a) {
    return a.ba === ob ? a.toJSON() : zb(a)
}

function Db(a) {
    if (!a) return a;
    if ("object" === typeof a) {
        if ($a(a)) return new Uint8Array(a);
        if (a.ba === ob) return a.clone()
    }
    return a
}
...
function E(a, b, c = !1) {
    return -1 === b ? null : b >= a.O ? a.v ? a.v[b] : void 0 : c && a.v && (c = a.v[b], null != c) ? c : a.m[b + a.J]
}

function F(a, b, c, d = !1, e = !1) {
    e || vb(a);
    a.l && (a.l = void 0);
    if (b >= a.O || d) return (a.v || (a.v = a.m[a.O + a.J] = {}))[b] = c, a;
    void 0 !== a.v && a.O >= a.m.length ? (d = a.m.length - 1, e = b + a.J, e >= d ? (a.m[d] = void 0, a.m[e] = c, a.m.push(a.v)) : a.m[e] = c) : a.m[b + a.J] = c;
    void 0 !== a.v && b in a.v && delete a.v[b];
    return a
}
...
function Fb(a, b, c, d) {
    ...
    const f = C(e);
    f & 1 || jb(e);
    if (D(a.m)) f & 2 || B(e, 2), c & 1 || Object.freeze(e);
    else if (e === ub || !(c & 1 && c & 2) && f & 2) e = jb(Array.prototype.slice.call(e)), F(a, b, e, d);
    else if (!(c & 2) && f & 16) {
        a = e;
...
function Ib(a, b, c) {
    const d = E(a, c, !1); {
        let f = !1;
        var e = null == d || "object" !== typeof d || (f = Array.isArray(d)) || d.ba !== ob ? f ? new b(d) : void 0 : d
    }
    e !== d && null != e && (F(a, c, e, !1, !0), B(e.m, C(a.m) & -33));
    b = e;
    if (null == b) return b;
    D(b.m) && !D(a.m) && (b = Jb(b), F(a, c, b, !1));
    return b
}

function Kb(a, b, c, d, e = !0) {
    a.i || (a.i = {});
    let f = a.i[c],
        g = Fb(a, c, 3, d);
    const h = D(a.m);
    if (f) h || (Object.isFrozen(f) ? e || (f = Array.prototype.slice.call(f), a.i[c] = f) : e && Object.freeze(f));
    else {
        f = [];
        const l = !!(C(a.m) & 16),
            m = D(g);
        !h && m && (g = jb(Array.prototype.slice.call(g)), F(a, c, g, d));
        d = m;
        for (let p = 0; p < g.length; p++) {
            var k = g[p];
            d = d || D(k);
            k = yb(k, b, l);
            void 0 !== k && (f.push(k), m && B(k.m, 2))
        }
        a.i[c] = f;
        a = g;
        Object.isFrozen(a) || (b = C(a) | 33, ib(a, d ? b & -9 : b | 8));
        (h || e && m) && B(f, 2);
        (h || e) && Object.freeze(f)
    }
    return f
...
function Lb(a, b, c, d = !1) {
    ...
    if (e) {
        for (e = 0; e < b.length; e++)(c = b[e]) && D(c.m) && (c = e, d = Jb(b[e]), b[c] = d, a[e] = b[e].m);
        B(a, 8)
    }
    return b
}
...
function Qb(a, b) {
    if (null != a) {
        if (Za && a instanceof Uint8Array) return a.length ? new fb(new Uint8Array(a), bb) : eb();
        if (Array.isArray(a)) {
            if (D(a)) return a;
            b && (b = C(a), b = !(b & 32) && (!!(b & 16) || 0 === b));
            return b ? (B(a, 2), a) : Bb(a, Qb, nb)
        }
        return a.ba === ob ? Rb(a) : a
    }
}
...
function Sb(a, b, c, d, e, f) {
    if (a = a.i && a.i[c]) {
        ...
        D(a) && Object.isFrozen(a) || (f = sa(a, Rb), nb(a, f), Object.freeze(f), a = f);
        var g = a;
        vb(b);
        if (null != g) {
            a = jb([]);
            f = !1;
            for (let h = 0; h < g.length; h++) a[h] = xb(g[h], d).m, f = f || D(a[h]);
            b.i || (b.i = {});
            b.i[c] = g;
            d = a;
            f ? hb(d, 8) : B(d, 8)
        } else b.i && (b.i[c] = void 0), a = ub;
        F(b, c, a, e)
    } else F(b, c, Qb(d, f), e)
}
...
function Tb(a) {
    ...
    for (let e = 0; e < c.length; e++) {
        let f = c[e];
        if (e === c.length - 1 && pb(f))
            for (const g in f) {
                const h = +g;
                Number.isNaN(h) ? (b.v || (b.v = b.m[b.O + b.J] = {}))[h] = f[h] : Sb(a, b, h, f[g], !0, d)
            } else Sb(a, b, e - a.J, f, !1, d)
    }
    return b
}
...
var I = class {
    constructor(a, b, c) {
        ...
        if (null == a) {
            ...
            if (h = !!(C(a) & 16)) g = C(a), ib(a, g | 32), g = !!(g & 32)
        }
        ...
        a: {
            ...
            if (f && (f = this.m[d], pb(f))) {
                this.v = f;
                b = Object.keys(f);
                0 < b.length && Array.prototype.every.call(b, isNaN, void 0) ? this.O = Number.MAX_VALUE :
                    this.O = d - this.J;
                break a
            }
            void 0 !== b && -1 < b ? (this.O = Math.max(b, d + 1 - this.J), this.v = void 0) : this.O = Number.MAX_VALUE
        }
        if (!e && this.v && "g" in this.v) throw Error('Unexpected "g" flag in sparse object of message that is not a group type.');
        if (c)
            for (e = h && !g ? kb : jb, b = 0; b < c.length; b++) h = c[b], (g = E(this, h)) ? Array.isArray(g) && e(g) : F(this, h, ub, !1, !0)
    }
    toJSON() {
        const a = Xb(this.m);
        return qb ? a : Bb(a, Cb, Eb)
    }
    clone() {
        var a = Bb(this.m, Db, mb);
        lb(a);
        Wb = a;
...
function Xb(a) {
    ...
    for (let g = a.length; g--;) {
        ...
        if (Array.isArray(h)) {
            var e = h;
            Array.isArray(h) && h && C(h) & 1 && !h.length ? h = null : h = Xb(h);
            h != e && (d = !0)
            ...
            a: {
                ...
                for (let l in f) {
                    ...
                    if (Array.isArray(m)) {
                        let p = m;
                        Array.isArray(m) && m && C(m) & 1 && !m.length ? m = null : m = Xb(m);
                        m != p && (k = !0)
                    }
                    null != m ? e[l] = m : k = !0
                }
    ...
    if (c) {
        ...
        for (let f in c) {
            ...
            if (g) {
                ...
                if (Array.isArray(g)) {
                    if (g.length)
                        for (d = Lb(a, g[0].constructor, e, d), e = 0; e < Math.min(d.length, g.length); e++) Yb(d[e], g[e])
...
function bc(a) {
    ...
    if (a.constructor === fb) return {
        buffer: gb(a) || ab || (ab = new Uint8Array(0)),
        M: !0
    };
...
const cc = "function" === typeof Uint8Array.prototype.slice;
...
var gc = class {
        ...
        init(a, b, c, {
            ...
            this.fa = d;
            a && (a = bc(a), this.j = a.buffer, this.o = a.M, this.l = b || 0, this.i = void 0 !== c ? this.l + c : this.j.length, this.h = this.l)
        }
        clear() {
            this.j = null;
            this.o = !1;
...
function jc(a) {
    switch (a.i) {
        ...
        case 1:
            ...
            break;
        case 2:
            2 != a.i ? jc(a) : (b = ec(a.h) >>> 0, a.h.advance(b));
            break;
        case 5:
            a.h.advance(4);
            break;
...
function rc(a) {
    var b = a.Lb;
    if (b) return oc(b);
    if (b = a.Vb) return nc(a.Na.ga, b, a.Ub)
}
        ...
        if (!e || !e(b, a, d))
            if (f = b, d = a, e = f.j, jc(f), !f.Y) {
                ...
                a: {
                    ...
                    const h = fc(f, e);f.fa && f.o ? e = f.j.subarray(h, h + e) : (f = f.j, g = h, e = h + e, e = g === e ? ab || (ab = new Uint8Array(0)) : cc ? f.slice(g, e) : new Uint8Array(f.subarray(g, e)));e = 0 == e.length ? eb() : new fb(e, bb)
                }(f = d.P) ? f.push(e) : d.P = [e]
            }
    }
    return a
}
        ...
        for (n = 0; 80 > n; n++) {
            if (40 > n)
                if (20 > n) {
                    var M = G ^ x & (y ^ G);
                    var da = 1518500249
                } else M = x ^ y ^ G, da = 1859775393;
            else 60 > n ? (M = x & y | G & (x | y), da = 2400959708) : (M = x ^ y ^ G, da = 3395469782);
            M = ((p << 5 | p >>> 27) & 4294967295) + M + Ua + da + u[n] & 4294967295;
            Ua = G;
            G = y;
...
q.set = function(a, b, c) {
    let d, e, f, g = !1,
        h;
    "object" === typeof c && (h = c.hc, g = c.ic || !1, f = c.domain || void 0, e = c.path || void 0, d = c.za);
...
J.prototype.then = function(a, b, c) {
    return nd(this, "function" === typeof a ? a : null, "function" === typeof b ? b : null, c)
};
J.prototype.$goog_Thenable = !0;
q = J.prototype;
q.cb = function(a, b) {
    return nd(this, null, a, b)
};
q.catch = J.prototype.cb;
q.cancel = function(a) {
    if (0 == this.h) {
        var b = new od(a);
        fd(function() {
    ...
    if (0 == a.h)
        if (a.j) {
            ...
            if (c.i) {
                ...
                e && (0 == c.h && 1 == d ? pd(c, b) : (f ? (d = f, d.next == c.l && (c.l = d), d.next = d.next.next) : qd(c), rd(c, e, 3, b)))
            }
            a.j = null
        } else id(a, 3, b)
}
...
function nd(a, b, c, d) {
    ...
    e.h = new J(function(f, g) {
        ...
        e.i = c ? function(h) {
            try {
                var k = c.call(d, h);
                void 0 === k && h instanceof od ? g(h) : f(k)
            } catch (l) {
                g(l)
            }
        } : g
...
function id(a, b, c) {
    if (0 == a.h) {
        ...
        g || (a.C = c, a.h = b, a.j = null, td(a), 3 != b || c instanceof od || vd(a, c))
    }
}
...
q.Ma = function() {
    for (var a; a = qd(this);) rd(this, a, this.h, this.C);
    this.u = !1
};
...
function rd(a, b, c, d) {
    ...
    if (b.h) b.h.j = null, wd(b, c, d);
    else try {
        b.l ? b.j.call(b.context) : wd(b, c, d)
    } catch (e) {
        xd.call(null, e)
    }
    Xc(kd, b)
...
q.oa = function(a) {
    ...
    if (b) {
        var c = this.i[b];
        0 != this.u ? (this.o.push(a), this.h[a + 1] = () => {}) : (c && ta(c, a), delete this.h[a], delete this.h[a + 1], delete this.h[a + 2])
    }
    return !!b
};
q.la = function(a, b) {
...
*/
var zd = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".split("");
var Ad = class extends I {
    constructor(a) {
        super(a)
    }
};
var Cd = class extends I {
        constructor(a) {
            super(a)
        }
        getKey() {
        ...
        ha() {
            return Ob(this, 2 === Hb(this, Bd) ? 2 : -1)
        }
    },
    Bd = [2, 3, 4, 5, 6];
...
var Hd = class extends I {
    ...
    Gd = [15, 26, 28];
var Id = class extends I {
    constructor(a) {
        super(a)
    }
};
var Kd = class extends I {
        constructor(a) {
            super(a, -1, Jd)
        }
    },
    Jd = [12];
var Md = class extends I {
        constructor(a) {
            super(a, -1, Ld)
        }
        j(a) {
...
var oe = class extends I {
    ...
    pe = [23, 24, 11, 6, 7, 5, 2, 3, 13, 20, 21, 22, 28, 32, 37, 229, 241, 45, 59, 225, 288, 72, 73, 78, 208, 156, 202, 215, 74, 76, 79, 80, 111, 85, 91, 97, 100, 102, 105, 119, 126, 127, 136, 146, 148, 151, 157, 158, 159, 163, 164, 168, 444, 176, 222, 383, 177, 178, 179, 411, 184, 188, 189, 190, 191, 193, 194, 195, 196, 197, 198, 199, 200, 201, 402, 320, 203, 204, 205, 206, 258, 259, 260, 261, 327, 209, 219, 226, 227, 232, 233, 234, 240, 244, 247, 248, 249, 251, 256, 257, 266, 254, 255, 270, 272, 278, 291, 293, 300, 304, 308, 309, 310, 311, 313, 314, 319, 321, 323,
        324, 328, 330, 331, 332, 334, 337, 338, 340, 344, 348, 350, 351, 352, 353, 354, 355, 356, 357, 358, 361, 363, 364, 368, 369, 370, 373, 374, 375, 378, 380, 381, 388, 389, 403, 410, 412, 429, 413, 414, 415, 416, 417, 418, 430, 423, 424, 425, 426, 427, 431, 117, 439, 441, 448
    ];
var qe = {
    Bb: 0,
    mb: 1,
...
function af(a, b) {
    ...
    f = e || f && !xa(f);
    !Ye && f && "POST" != b.method && (Ye = !0, Ne(Error("AJAX request with postData should use POST")));
    return e
};
...
function cf(a, b, c) {
    ...
    return d ? d(a, b, c) : void 0 === c ? (a(), NaN) : Xe(a, c || 0)
}
var ef = class extends df {
    i(a) {
...
function lf(a) {
    kf || (jf ? jf.handleError(a) : (hf.push({
        type: "ERROR",
        payload: a
    }), 10 < hf.length && hf.shift()))
}

function mf(a, b) {
    kf || (jf ? jf.aa(a, b) : (hf.push({
        type: "EVENT",
        eventType: a,
        payload: b
    }), 10 < hf.length && hf.shift()))
...
var R = class extends Q {
        constructor(a, b = {}, c = pf[a], d = qf[a], e = rf[a]) {
    ...
    sf = class extends R {
        constructor(a, b) {
            super("MISSING_OBJECT_STORES", {
                ...
                foundObjectStores: a
            }, pf.MISSING_OBJECT_STORES);
            Object.setPrototypeOf(this, sf.prototype)
        }
    },
...
const uf = ["The database connection is closing", "Can't start a transaction on a closed database", "A mutation operation was attempted on a database that did not allow mutations"];
...
function vf(a, b, c, d) {
    ...
    if (Ra && "UnknownError" === e.name) return new R("QUOTA_MAYBE_EXCEEDED", a);
    if (e instanceof tf) return new R("MISSING_INDEX", Object.assign({}, a, {
        objectStore: e.objectStore,
        index: e.index
    }));
    if ("InvalidStateError" === e.name && uf.some(f => e.message.includes(f))) return new R("EXECUTE_TRANSACTION_ON_CLOSED_DB",
        a);
...
function Af(a, b, c, d, e) {
    try {
        ...
        f instanceof Bf ? Cf(a, b, f, d, e) : d(f)
    } catch (f) {
        e(f)
    }
}
...
var Bf = class {
    ...
    static all(a) {
        return new Bf(new zf((b, c) => {
            const d = [];
            let e = a.length;
            0 === e && b(d);
            for (let f = 0; f < a.length; ++f) Bf.resolve(a[f]).then(g => {
                d[f] = g;
                e--;
                0 === e && b(d)
            }).catch(g => {
    ...
    static resolve(a) {
        return new Bf(new zf((b, c) => {
            a instanceof Bf ? a.then(b, c) : b(a)
        }))
    }
    then(a, b) {
        const c = null != a ? a : yf,
            d = null != b ? b : xf;
        return new Bf(new zf((e, f) => {
            "PENDING" === this.state.status ? (this.h.push(() => {
                Af(this, this, c, e, f)
            }), this.i.push(() => {
                Df(this, this, d, e, f)
            })) : "FULFILLED" === this.state.status ? Af(this, this, c, e, f) : "REJECTED" === this.state.status && Df(this, this, d, e, f)
        }))
    } catch (a) {
...
const Hf = window;
var T = Hf.ytcsi && Hf.ytcsi.now ? Hf.ytcsi.now : Hf.performance && Hf.performance.timing && Hf.performance.now && Hf.performance.timing.navigationStart ? () => Hf.performance.timing.navigationStart + Hf.performance.now() : () => (new Date).getTime();
    ...
    return r(function*() {
        ...
        for (; !h;) {
            ...
            try {
                ...
                var k = d;
                const p = new Jf(m),
                    u = yield Kf(p, k), n = Math.round(T());
                Lf(a, l, n, g, void 0, b.join(), e);
                return u
            } catch (m) {
                k = Math.round(T());
                const p = vf(m, a.h.name, b.join(), a.h.version);
                if (p instanceof R && !p.h || g >= f) Lf(a, l, k, g, p, b.join(), e),
                    h = p
            }
        }
...
function Lf(a, b, c, d, e, f, g) {
    b = c - b;
    e ? (e instanceof R && ("QUOTA_EXCEEDED" === e.type || "QUOTA_MAYBE_EXCEEDED" === e.type) && mf("QUOTA_EXCEEDED", {
        dbName: of (a.h.name),
        objectStoreNames: f,
        transactionCount: a.transactionCount,
        transactionMode: g.mode
    }), e instanceof R && "UNKNOWN_ABORT" === e.type && (c -= a.j, 0 > c && c >= Math.pow(2, 31) && (c = 0), mf("TRANSACTION_UNEXPECTEDLY_ABORTED", {
        objectStoreNames: f,
        transactionDuration: b,
        transactionCount: a.transactionCount,
        dbDuration: c
    }), a.i = !0), Pf(a, !1, d, f, b, g.tag), lf(e)) : Pf(a, !0, d, f, b, g.tag)
}

function Pf(a, b, c, d, e, f = "IDB_TRANSACTION_TAG_UNKNOWN") {
    mf("TRANSACTION_ENDED", {
        objectStoreNames: d,
...
var Nf = class {
    ...
    delete(a) {
        return a instanceof IDBKeyRange ? Tf(this, a) : S(this.h.delete(a))
    }
    get(a) {
    ...
    index(a) {
        try {
            return new Uf(this.h.index(a))
        } catch (b) {
            if (b instanceof Error && "NotFoundError" === b.name) throw new tf(a, this.h.name);
            throw b;
        }
    }
    keyPath() {
...
function Sf(a) {
    return S(a).then(b => b ? new Wf(a, b) : null)
}
var Wf = class {
    constructor(a, b) {
        this.request = a;
    ...
    return new Promise((d, e) => {
        ...
        f.addEventListener("upgradeneeded", n => {
            try {
                ...
                n.dataLoss && "none" !== n.dataLoss && mf("IDB_DATA_CORRUPTED", {
                    reason: n.dataLossMessage || "unknown reason",
                    dbName: of (a)
                });
                const x = u(),
                    y = new Jf(f.transaction);
...
function bg(a, b) {
    if (!b) throw wf("openWithToken", of (a.name));
    return a.open()
}
var cg = class {
    constructor(a, b) {
    ...
    delete(a = {}) {
        return Zf(this.name, a)
    }
    open() {
        if (!this.l) throw ag(this);
        ...
        const b = () => {
            ...
            d = () => {
                ...
                return r(function*() {
                    ...
                    try {
                        const k = yield e.j(e.name, e.options.version, c);
                        f = k;
                        var h = e.options;
                        const l = [];
                        ...
                        if (0 !== l.length) {
                            ...
                            if (e.u < He("ytidb_reopen_db_retries", 0)) return e.u++, k.close(), lf(new R("DB_REOPENED_BY_MISSING_OBJECT_STORES", {
                                dbName: e.name,
                                expectedObjectStores: m,
                                foundObjectStores: p
                            })), d();
                            if (e.o < He("ytidb_remake_db_retries", 1)) return e.o++, P("ytidb_remake_db_enable_backoff_delay") && (yield $f(e.i), e.i *= 2), yield e.delete(), lf(new R("DB_DELETED_BY_MISSING_OBJECT_STORES", {
                                dbName: e.name,
                                expectedObjectStores: m,
                                foundObjectStores: p
                            })), d();
                        ...
                        if (k instanceof DOMException ? "VersionError" === k.name : "DOMError" in self && k instanceof DOMError ? "VersionError" === k.name : k instanceof Object && "message" in k &&
                            ...
                            g = yield e.j(e.name, void 0, Object.assign({}, c, {
                                upgrade: void 0
                            }));
                            h = g.h.version;
                            if (void 0 !== e.options.version && h > e.options.version + 1) throw g.close(), e.l = !1, ag(e, h);
                            return g
                        }
                        b();
                        k instanceof Error && !P("ytidb_async_stack_killswitch") && (k.stack = `${k.stack}\n${g.substring(g.indexOf("\n")+1)}`);
                        let l;
                        throw vf(k, e.name, "", null != (l = e.options.version) ? l : -1);
                    }
                })
            };
        return this.h = a = d()
...
function eg(a, b) {
    return r(function*() {
        return If(yield bg(dg, b), ["databases"], {
            K: !0,
            mode: "readwrite"
        }, c => {
...
function fg(a, b) {
    return r(function*() {
        if (a) return (yield bg(dg, b)).delete("databases", a)
    })
};
let gg;
const hg = new class {
...
function kg() {
    ...
    return a ? Promise.resolve(a) : jg().then(b => {
        (b = b ? hg : void 0) && v("ytglobal.idbToken_", b);
        return b
    })
};
new hd;
...
function mg(a, b, c, d) {
    return r(function*() {
        ...
        e = yield kg();
        if (!e) throw e = wf("openDbImpl", a, b), P("ytidb_async_stack_killswitch") || (e.stack = `${e.stack}\n${f.substring(f.indexOf("\n")+1)}`), lf(e), e;
        nf(a);
        f = c ? {
            actualName: a,
            publicName: a,
        ...
        try {
            return yield eg(f, e), yield Yf(f.actualName, b, d)
        } catch (g) {
            try {
                yield fg(f.actualName, e)
            } catch (h) {}
            throw g;
        }
    })
...
function pg(a, b = {}) {
    return r(function*() {
        ...
        if (c) {
            nf(a);
            var d = lg(a);
            yield Zf(d.actualName, b);
            yield fg(d.actualName, c)
        }
    })
}
...
function qg(a, b = {}) {
    return r(function*() {
        const c = yield kg();
        c && (nf(a), yield Zf(a, b), yield fg(a, c))
    })
};
...
var sg = class extends cg {
    ...
    j(a, b, c = {}) {
        return (this.options.ma ? og : ng)(a, b, Object.assign({}, c))
    }
    delete(a = {}) {
        return (this.options.ma ? qg : pg)(this.name, a)
    }
};
var tg = class {};
...
function vg() {
    return {
        ...
        ia: O("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),
        Pa: O("INNERTUBE_CONTEXT_CLIENT_NAME", "WEB"),
        Qa: O("INNERTUBE_CONTEXT_CLIENT_NAME", 1),
        innertubeContextClientVersion: O("INNERTUBE_CONTEXT_CLIENT_VERSION"),
        xa: O("INNERTUBE_CONTEXT_HL"),
        wa: O("INNERTUBE_CONTEXT_GL"),
        Ra: O("INNERTUBE_HOST_OVERRIDE") || "",
        Ta: !!O("INNERTUBE_USE_THIRD_PARTY_AUTH", !1),
        Sa: !!O("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT", !1),
...
function wg(a) {
    ...
    xg(a, void 0, b);
    P("start_sending_config_hash") && yg(void 0, b);
...
function zg(a) {
    ...
    if (a.ia) {
        ...
        H(c, Dd, 62, e)
    }(d = t.devicePixelRatio) && 1 != d && F(c, 65, d);
    d = Ie();
    "" !== d && F(c, 54, d);
    d = Je();
    if (0 < d.length) {
    ...
    xg(a, c);
    P("start_sending_config_hash") && yg(c);
    O("DELEGATED_SESSION_ID") && !P("pageid_as_header_web") && (a = new Kd, F(a, 3, O("DELEGATED_SESSION_ID")));
    a = O("DEVICE", "");
    for (const [f, g] of Object.entries(Ue(a))) a = f, d = g, "cbrand" === a ? F(c, 12, d) : "cmodel" === a ? F(c, 13, d) : "cbr" === a ? F(c, 87, d) : "cbrver" === a ? F(c, 88, d) : "cos" === a ? F(c, 18, d) : "cosver" === a ? F(c, 19, d) : "cplatform" === a && F(c, 42, d);
    b.j(c);
    return b
}
...
function Ag(a, b, c = {}) {
    ...
    (b = c.Jb || O("AUTHORIZATION")) || (a ? b = `Bearer ${w("gapi.auth.getToken")().Ib}` : b = Uc());
...
function yg(a, b) {
    ...
    const {
        ...
        coldConfigData: w("yt.gcf.config.coldConfigData"),
        hotHashData: w("yt.gcf.config.hotHashData"),
        coldHashData: w("yt.gcf.config.coldHashData")
    };
    if (c && d && e)
        if (a) {
            let f;
            b = null != (f = Ib(a, Dd, 62)) ? f : new Dd;
            F(b, 1, c);
            F(b, 3, d);
            F(b, 5, e);
            H(a, Dd, 62, b)
...
const Eg = w("ytPubsub2Pubsub2Instance") || new K;
K.prototype.subscribe = K.prototype.Ga;
K.prototype.unsubscribeByKey = K.prototype.oa;
K.prototype.publish = K.prototype.la;
K.prototype.clear = K.prototype.clear;
v("ytPubsub2Pubsub2Instance", Eg);
const Fg = w("ytPubsub2Pubsub2SubscribedKeys") || {};
v("ytPubsub2Pubsub2SubscribedKeys", Fg);
const Gg = w("ytPubsub2Pubsub2TopicToKeys") || {};
v("ytPubsub2Pubsub2TopicToKeys", Gg);
const Hg = w("ytPubsub2Pubsub2IsAsync") || {};
v("ytPubsub2Pubsub2IsAsync", Hg);
...
function Lg(a) {
    ...
    Fg[d] = !0;
    Gg[b.toString()] || (Gg[b.toString()] = []);
    Gg[b.toString()].push(d);
    return d
}

function Mg() {
    var a = Ng;
    const b = Lg(function(c) {
...
const Pg = ["client.name", "client.version"];

function Qg(a) {
    if (!a.errorMetadata || !a.errorMetadata.kvPairs) return a;
    a.errorMetadata.kvPairs = a.errorMetadata.kvPairs.filter(b => b.key ? Pg.includes(b.key) : !1);
    return a
};
var Rg;
Rg = rg("ServiceWorkerLogsDatabase", {
    S: {
        SWHealthLog: {
            X: 1
        }
...
function Sg(a, b) {
    return r(function*() {
        var c = yield bg(Rg(), b), d = O("INNERTUBE_CONTEXT_CLIENT_NAME", 0);
        const e = Object.assign({}, a);
        e.clientError && (e.clientError = Qg(e.clientError));
        e.interface = d;
        return Of(c, "SWHealthLog", e)
    })
};
...
function Tg(a) {
    !a.config_ && ug() && (a.config_ = vg());
    return !!a.config_
}

function Ug(a, b, c) {
    !O("VISITOR_DATA") && .01 > Math.random() && Oe(new Q("Missing VISITOR_DATA when sending innertube request.", "log_event", b, c));
    if (!Tg(a)) throw a = new Q("innertube xhrclient not ready", "log_event", b, c), Ne(a), a;
    b = {
        headers: c.headers || {},
        method: "POST",
        postParams: b,
    ...
    var e = a.config_.Ra;
    e && (d = e);
    e = Ag(a.config_.Ta || !1, d, c);
    Object.assign(b.headers, e);
    (e = b.headers.Authorization) && !d && (b.headers["x-origin"] = window.location.origin);
    ...
    try {
        ...
        if ("InvalidAccessError" ==
            k.name) Oe(Error("An extension is blocking network request."));
        else throw k;
    }
}
class Vg {
    constructor(a) {
        this.config_ = null;
        a ? this.config_ = a : ug() && (this.config_ = vg())
    }
};
let Wg = 0;
v("ytDomDomGetNextId", w("ytDomDomGetNextId") || (() => ++Wg));
const Xg = {
...
class Zg {
    constructor(a) {
        ...
        try {
            if (a = a || window.event) {
                this.event = a;
                for (let d in a) d in Xg || (this[d] = a[d]);
...
const $g = t.ytEventsEventsCounter || {
    count: 0
};
v("ytEventsEventsCounter", $g);
...
const gh = window.ytcsi && window.ytcsi.now ? window.ytcsi.now : window.performance && window.performance.timing && window.performance.now && window.performance.timing.navigationStart ? function() {
...
function hh(a) {
    ...
    this.o = 0;
    this.Da = ch(window, "mousemove", na(this.Ea, this));
    a = na(this.Ca, this);
    "function" === typeof a && (a = Me(a));
...
hh.prototype.Ca = function() {
    if (this.h) {
        ...
        if (0 != this.u) {
            ...
            this.i[this.o] = .5 < Math.abs((d - this.C) / this.C) ? 1 : 0;
...
function jh() {
    ...
    if (null == w("_lact", window)) {
        ...
        v("_lact", c, window);
        v("_fact", c, window); - 1 == c && kh();
        ch(document, "keydown", kh);
        ch(document, "keyup", kh);
        ch(document, "mousedown", kh);
        ch(document, "mouseup", kh);
        ...
        ch(document, "touchstart", kh, {
            passive: !0
        });
        ch(document, "touchend", kh, {
            passive: !0
        })
    }
}
...
t.ytPubsubPubsubInstance || new K;

function nh(a, b) {
    const c = oh(b);
    if (a.h[c]) return a.h[c];
    const d = Object.keys(a.store) || [];
    if (1 >= d.length && oh(b) === d[0]) return d;
    const e = [];
    for (let g = 0; g < d.length; g++) {
        const h = d[g].split("/");
        if (ph(b.auth, h[0])) {
            var f = b.isJspb;
            ph(void 0 === f ? "undefined" : f ? "true" : "false", h[1]) && ph(b.cttAuthInfo, h[2]) && e.push(d[g])
        }
    }
    return a.h[c] = e
}
...
qh.prototype.getSequenceCount = qh.prototype.getSequenceCount;
qh.prototype.extractMatchingEntries = qh.prototype.extractMatchingEntries;
qh.prototype.storePayload = qh.prototype.storePayload;
...
const rh = He("initial_gel_batch_timeout", 2E3),
    sh = Math.pow(2, 16) - 1;
let U = void 0;
class th {
    constructor() {
...
const uh = new th,
    vh = new th;
let wh, xh = !0;
const yh = t.ytLoggingTransportGELQueue_ || new Map,
    zh = t.ytLoggingTransportGELProtoQueue_ || new Map,
    Ah = t.ytLoggingTransportTokensToCttTargetIds_ || {},
    Bh = t.ytLoggingTransportTokensToJspbCttTargetIds_ || {};
let Ch = {};

function Dh() {
    let a = w("yt.logging.ims");
    a || (a = new qh, v("yt.logging.ims", a));
    return a
}

function Eh(a, b) {
    P("web_all_payloads_via_jspb") && Oe(new Q("transport.log called for JSON in JSPB only experiment"));
    if ("log_event" === a.endpoint) {
        ...
        if (P("use_new_in_memory_storage")) {
            ...
            Dh().storePayload(d, a.payload);
            Gh(b, [], c, !1, d)
        } else d = yh.get(c) || [], yh.set(c, d), d.push(a.payload), Gh(b, d, c)
    }
}
...
function Hh(a, b) {
    if ("log_event" === a.endpoint) {
        ...
        if (P("use_new_in_memory_storage")) {
            ...
            Dh().storePayload(d, a.payload.toJSON());
            Gh(b, [], c, !0, d)
        } else d = zh.get(c) || [], zh.set(c, d), a = a.payload.toJSON(), d.push(a), Gh(b, d, c, !0)
    }
}

function Gh(a, b, c, d = !1, e) {
    a && (U = new a);
    a = He("tvhtml5_logging_max_batch") || He("web_logging_max_batch") || 100;
    const f = T(),
        g = d ? vh.j : uh.j;
    b = b.length;
    e && (b = Dh().getSequenceCount(e));
    b >= a ? P("background_thread_flush_logs_due_to_batch_limit") ? wh || (wh = Ih(() => {
        Jh({
            writeThenSend: !0
        ...
        writeThenSend: !0
    }, P("flush_only_full_queue") ? c : void 0, d) : 10 <= f - g && (Kh(d), d ? vh.j = f : uh.j = f)
}

function Lh(a, b) {
    P("web_all_payloads_via_jspb") && Oe(new Q("transport.logIsolatedGelPayload called in JSPB only experiment"));
    if ("log_event" === a.endpoint) {
        var c = Fh(a),
            d = new Map;
        d.set(c, [a.payload]);
...
function Fh(a, b = !1) {
    var c = "";
    if (a.R) c = "visitorOnlyApprovedKey";
    else if (a.cttAuthInfo) {
        if (b) {
            b = a.cttAuthInfo.token;
            c = a.cttAuthInfo;
            const d = new te;
            c.videoId ? d.setVideoId(c.videoId) : c.playlistId && Gb(d, 2, se, c.playlistId);
            Bh[b] = d
        } else b = a.cttAuthInfo, c = {}, b.videoId ? c.videoId = b.videoId : b.playlistId && (c.playlistId = b.playlistId), Ah[a.cttAuthInfo.token] = c;
...
function Jh(a = {}, b, c = !1) {
    !c && P("web_all_payloads_via_jspb") && Oe(new Q("transport.flushLogs called for JSON in JSPB only experiment"));
    new J((d, e) => {
        c ? (Ph(vh.i), Ph(vh.h), vh.h = 0) : (Ph(uh.i), Ph(uh.h), uh.h = 0);
        U && Tg(U) ? P("use_new_in_memory_storage") ? Qh(d, e, a, b, c) : Rh(d, e, a, b, c) : (Kh(c), d())
    })
}
...
function Qh(a, b, c = {}, d, e = !1) {
    var f = U,
        g = new Map;
    const h = new Map;
    if (void 0 !== d) e ? (b = Dh().extractMatchingEntries({
        isJspb: e,
        cttAuthInfo: d
    }), g.set(d, b), Oh(g, f, a, c)) : (g = Dh().extractMatchingEntries({
        isJspb: e,
        cttAuthInfo: d
    }), h.set(d, g), Mh(h, f, a, b, c));
    else if (e) {
        for (const k of Object.keys(Ch)) b = Dh().extractMatchingEntries({
            isJspb: !0,
            cttAuthInfo: k
        }), 0 < b.length && g.set(k, b), delete Ch[k];
        Oh(g, f, a, c)
    } else {
        for (const k of Object.keys(Ch)) d = Dh().extractMatchingEntries({
            isJspb: !1,
            cttAuthInfo: k
        }), 0 < d.length && h.set(k,
            d), delete Ch[k];
...
function Rh(a, b, c = {}, d, e = !1) {
    var f = U;
    if (void 0 !== d)
        if (e) b = new Map, e = zh.get(d) || [], b.set(d, e), Oh(b, f, a, c), zh.delete(d);
        else {
            e = new Map;
            const g = yh.get(d) || [];
            e.set(d, g);
    ...
    else e ? (Oh(zh, f, a, c), zh.clear()) : (Mh(yh, f, a, b, c), yh.clear())
}

function Kh(a = !1) {
    if (P("web_gel_timeout_cap") && (!a && !uh.h || a && !vh.h)) {
        var b = Ih(() => {
            Jh({
                writeThenSend: !0
            }, void 0, a)
    ...
    Ph(a ? vh.i : uh.i);
    b = O("LOGGING_BATCH_TIMEOUT", He("web_gel_debounce_ms", 1E4));
    P("shorten_initial_gel_batch_timeout") && xh && (b = rh);
    b = Ih(() => {
        Jh({
            writeThenSend: !0
        }, void 0, a)
...
function Mh(a, b, c, d, e = {}, f) {
    ...
    for (const [l, m] of a) {
        ...
        var k = m;
        const p = ya({
            context: wg(b.config_ || vg())
        });
        if (!ja(k) && !P("throw_err_when_logevent_malformed_killswitch")) {
            d();
            break
        }
        p.events = k;
...
function Oh(a, b, c, d = {}, e) {
    ...
    for (const [m] of h) {
        var k = m,
            l = a.get(k);
        h = new ve;
        const p = zg(b.config_ || vg());
        H(h, Md, 1, p);
        l = l ? Wh(l) : [];
        for (const u of l) Nb(h, 3, oe, u);
        (l = Bh[k]) && Xh(h, k, l);
        delete Bh[k];
...
function Vh(a, b, c, d, e) {
    ...
    Zh() && (a.headers["X-Goog-Request-Time"] = JSON.stringify(Math.round(T())));
    return a
}

function Th(a, b, c) {
    Zh() || (a.requestTimeMs = String(b));
    P("unsplit_gel_payloads_in_logs") && (a.unsplitGelPayloadsInLogs = !0);
    !c && (b = O("EVENT_ID")) && (c = $h(), a.serializedClientEventId = {
        serializedEventId: b,
...
function $h() {
    ...
    a || (a = Math.floor(Math.random() * sh / 2));
    a++;
    a > sh && (a = 1);
...
function Xh(a, b, c) {
    let d;
    if (Ob(c, 1 === Hb(c, se) ? 1 : -1)) d = 1;
    else if (Ob(c, 2 === Hb(c, se) ? 2 : -1)) d = 2;
    else return;
    H(a, te, 4, c);
    a = Ib(a, Md, 1) || new Md;
    c = Ib(a, Kd, 3) || new Kd;
...
function Wh(a) {
    ...
    for (let c = 0; c < a.length; c++) try {
        ...
        Ne(new Q("Transport failed to deserialize " + String(a[c])))
    }
    return b
}
...
function Ih(a, b) {
    var c;
    P("transport_use_scheduler") ? c = cf(a, 0, b) : c = Xe(a, b);
    return c
}

function Ph(a) {
    P("transport_use_scheduler") ? ff.i(a) : window.clearTimeout(a)
};
const ai = t.ytLoggingGelSequenceIdObj_ || {};
...
function V(a, b, c, d = {}) {
    ...
    e[a] = b;
    P("enable_unknown_lact_fix_on_html5") && jh();
    a = mh();
    e.context = {
        lastActivityMs: String(d.timestamp || !isFinite(a) ? -1 : a)
    };
    P("log_sequence_info_on_gel_web") && d.D && (a = e.context, b = d.D, b = {
        index: bi(b),
        groupKey: b
    }, a.sequence = b, d.va && delete ai[d.D]);
    (d.Ya ? Lh : Eh)({
        endpoint: "log_event",
        payload: e,
...
function ei(a, b, c = {}) {
    let d = di;
    O("ytLoggingEventsDefaultDisabled", !1) && di === Vg && (d = null);
    P("web_all_payloads_via_jspb") && Oe(new Q("Logs should be translated to JSPB but are sent as JSON instead", a));
    V(a, b, d, c)
};
const fi = t.ytLoggingGelSequenceIdObj_ || {};
...
function gi(a, b, c = {}) {
    ...
    var e = mh();
    d = new ne;
    F(d, 1, c.timestamp || !isFinite(e) ? -1 : e);
    if (P("log_sequence_info_on_gel_web") && c.D) {
        e = c.D;
        const f = bi(e),
            g = new me;
        F(g, 2, f);
...
function W(a, b, c = {}) {
    if (P("migrate_events_to_ts")) ei(a, b, c);
    else {
        var d = pi;
        O("ytLoggingEventsDefaultDisabled", !1) && pi == Vg && (d = null);
        V(a, b, d, c)
    }
};
const qi = [{
        ...
        for (e in a) {
            if (a[e]) {
                ...
                var g = a[e],
                    h = b,
                    k = c;
                f = "string" !== typeof g || "clickTrackingParams" !== f && "trackingParams" !== f ? 0 : (g = yi(atob(g.replace(/-/g, "+").replace(/_/g, "/")))) ? Bi(`${f}.ve`, g, h, k) : 0;
                d += f;
                d += Bi(e, a[e], b, c);
                if (500 < d) break
            }
...
var Di = new Set,
    ...
    Gi = 0,
    Hi = [];
const Ii = ["PhantomJS", "Googlebot", "TO STOP THIS SECURITY SCAN go/scan"];
    ...
    if (a) {
        ...
        if (!(5 <= Ei)) {
            ...
            const G = e.message || "Unknown Error",
                Ua = e.name || "UnknownError";
            var f = e.stack || a.i || "Not available";
            if (f.startsWith(`${Ua}: ${G}`)) {
                var g = f.split("\n");
                g.shift();
                f = g.join("\n")
            }
            ...
            if (a.hasOwnProperty("args") && a.args && a.args.length)
                for (var h = 0; h < a.args.length && !(M = Ai(a.args[h], `params.${h}`, b, M), 500 <= M); h++);
                ...
                if ("object" === typeof a.params)
                    for (h in da) {
                        ...
                        b[dh] =
                            eh;
                        M += dh.length + eh.length;
                        if (500 < M) break
                    } else b.params = Ci(da)
            }
            if (d.length)
                for (h = 0; h < d.length && !(M = Ai(d[h], `params.context.${h}`, b, M), 500 <= M); h++);
            ...
            if ("IGNORED" === a.level) var k = 0;
                ...
                a = ti();d = b;
                for (k of a.H)
                    if (d.message && d.message.match(k.Ua)) {
                        k = k.weight;
                        break a
                    }
                for (var l of a.G)
            ...
            if (0 !== k.sampleWeight && !Di.has(k.message)) {
                "ERROR" === c ? (xi.la("handleError", k), P("record_app_crashed_web") && 0 === Gi && 1 === k.sampleWeight && (Gi++, P("errors_via_jspb") ? (m = new Yd, F(m, 1, 1), P("report_client_error_with_app_crash_ks") || (l = new Td, F(l, 1, k.message), p = new Ud, H(p, Td, 3, l), l = new Vd, H(l, Ud, 5, p), p = new Xd, H(p,
                    Vd, 9, l), H(m, Xd, 4, p)), p = new oe, Mb(p, Yd, 20, pe, m), hi(p)) : (m = {
                    appCrashType: "APP_CRASH_TYPE_BREAKPAD"
                }, P("report_client_error_with_app_crash_ks") || (m.systemHealth = {
                    crashData: {
                        clientError: {
                            logMessage: {
                                message: k.message
                ...
                }), W("appCrashed", m))), Fi++) : "WARNING" === c && xi.la("handleWarning", k);
                a: {
                    if (P("errors_via_jspb")) {
                        if (Ni()) var u = void 0;
                            ...
                            m = new Qd;
                            F(m, 1, k.stack);
                            k.fileName && F(m, 4, k.fileName);
                            var n = k.lineNumber && k.lineNumber.split ? k.lineNumber.split(":") : [];
                            0 !== n.length && (1 !== n.length || isNaN(Number(n[0])) ?
                                2 !== n.length || isNaN(Number(n[0])) || isNaN(Number(n[1])) || (F(m, 2, Number(n[0])), F(m, 3, Number(n[1]))) : F(m, 2, Number(n[0])));
                            n = new Td;
                            F(n, 1, k.message);
                            F(n, 3, k.name);
                            F(n, 6, k.sampleWeight);
                            "ERROR" === c ? F(n, 2, 2) : "WARNING" === c ? F(n, 2, 1) : F(n, 2, 0);
                            var x = new Rd;
                            F(x, 1, !0);
                            Mb(x, Qd, 3, Sd, m);
                            m = new Od;
                            F(m, 3, window.location.href);
                            p = O("FEXP_EXPERIMENTS", []);
                            for (b = 0; b < p.length; b++) l = m, a = p[b], vb(l), Fb(l, 5, 2, !1).push(a);
                            p = Ee();
                            if (!Fe() && p)
                                for (var y of Object.keys(p)) l = new Pd, F(l, 1, y), F(l, 2, String(p[y])), Nb(m, 4, Pd, l);
                            if (y =
                                k.params)
                                for (u of Object.keys(y)) p = new Pd, F(p, 1, `client.${u}`), F(p, 2, String(y[u])), Nb(m, 4, Pd, p);
                            y = O("SERVER_NAME");
                            u = O("SERVER_VERSION");
                            y && u && (p = new Pd, F(p, 1, "server.name"), F(p, 2, y), Nb(m, 4, Pd, p), y = new Pd, F(y, 1, "server.version"), F(y, 2, u), Nb(m, 4, Pd, y));
                            u = new Ud;
                            H(u, Od, 1, m);
                            H(u, Rd, 2, x);
                            H(u, Td, 3, n)
                        ...
                        if (Ni()) u = void 0;
                            ...
                            0 !== u.length &&
                                (1 !== u.length || isNaN(Number(u[0])) ? 2 !== u.length || isNaN(Number(u[0])) || isNaN(Number(u[1])) || (y.lineNumber = Number(u[0]), y.columnNumber = Number(u[1])) : y.lineNumber = Number(u[0]));
                            u = {
                            ...
                            O("FEXP_EXPERIMENTS") && (m.experimentIds = O("FEXP_EXPERIMENTS"));
                            p = Ee();
                            if (!Fe() && p)
                    ...
                    if ("ERROR" === c || P("errors_flush_gel_always_killswitch")) b: if (P("migrate_events_to_ts")) c: {
                        if (P("web_fp_via_jspb") &&
                            (ci(!0), !P("web_fp_via_jspb_and_json"))) break c;ci()
                    }
                    else {
                        if (P("web_fp_via_jspb") && (ci(!0), !P("web_fp_via_jspb_and_json"))) break b;
                        ci()
                    }
                }
                try {
...
var Qi = class {
    ...
    getAsJson() {
        const a = {};
        void 0 !== this.s.trackingParams ? a.trackingParams = this.s.trackingParams : (a.veType = this.s.veType, void 0 !== this.s.veCounter && (a.veCounter = this.s.veCounter), void 0 !== this.s.elementIndex && (a.elementIndex = this.s.elementIndex));
        void 0 !== this.s.dataElement && (a.dataElement = this.s.dataElement.getAsJson());
        void 0 !== this.s.youtubeData && (a.youtubeData = this.s.youtubeData);
        return a
    }
    getAsJspb() {
        const a = new L;
        if (void 0 !== this.s.trackingParams) {
            var b = this.s.trackingParams;
            if (null != b)
                if ("string" === typeof b) b = b ? new fb(b, bb) : eb();
                else if (b.constructor !== fb)
                if ($a(b)) b = b.length ? new fb(new Uint8Array(b), bb) : eb();
                else throw Error();
            F(a, 1, b)
        } else void 0 !== this.s.veType && F(a, 2, this.s.veType), void 0 !== this.s.veCounter && F(a, 6, this.s.veCounter), void 0 !== this.s.elementIndex && F(a, 3, this.s.elementIndex);
        void 0 !== this.s.dataElement && (b = this.s.dataElement.getAsJspb(), H(a, L, 7, b));
        void 0 !== this.s.youtubeData && H(a, Ad, 8, this.s.jspbYoutubeData);
        return a
    }
    toString() {
    ...
    isClientVe() {
        return !this.s.trackingParams &&
            !!this.s.veType
    }
};
let Si = Date.now().toString();
let Ti = t.ytLoggingDocDocumentNonce_;
if (!Ti) {
    var Ui;
    a: {
        ...
        if (Si) {
            let d = 1;
            for (let e = 0; e < Si.length; e++) c[d % 16] = c[d % 16] ^ c[(d - 1) % 16] / 4 ^ Si.charCodeAt(e), d++
        }
        Ui = c
    }
    const a = Ui,
...
function ej(a, b, c = 0, d) {
    if (a !== O(Yi(c)) || b !== O(Zi(c)))
        if (cj(a, d, c), N(Yi(c), a), N(Zi(c), b), b = () => {
                setTimeout(() => {
                    if (a)
                        if (P("web_time_via_jspb")) {
                            ...
                            F(e, 1, Vi);
                            F(e, 2, a);
                            P("use_default_heartbeat_client") ? oi(e) : oi(e, void 0, Wi)
                        } else e = {
                            clientDocumentNonce: Vi,
                            clientScreenNonce: a
                        }, P("use_default_heartbeat_client") ? W("foregroundHeartbeatScreenAssociated", e) : V("foregroundHeartbeatScreenAssociated", e, Wi)
                }, 0)
...
function jj(a, b, c, d, e, f, g) {
    ...
    e && (f.cttAuthInfo = e);
    e = () => {
        Li(new Q("newScreen() parent element does not have a VE - rootVe", b))
    };
    if (P("il_via_jspb")) {
        const l = new ce;
        l.h(h);
        be(l, k.getAsJspb());
        c && c.visualElement ? (k = new ee, c.clientScreenNonce && F(k, 2, c.clientScreenNonce), de(k, c.visualElement.getAsJspb()), g && F(k, 4, qe[g]), H(l, ee, 5, k)) : c && e();
        d && F(l, 3, d);
        mi(l, f, a)
    } else k = {
        csn: h,
...
function kj(a, b, c, d) {
    const e = d.filter(g => {
        ...
        f = {
            cttAuthInfo: dj(b) || void 0,
            D: b
        };
    for (const g of d) d = g.getAsJson(), (xa(d) || !d.trackingParams && !d.veType) && Li(Error("Child VE logged with no data"));
    if (P("il_via_jspb")) {
        const g = new he;
        g.h(b);
        fe(g, c.getAsJspb());
        ...
        "UNDEFINED_CSN" === b ? Y("visualElementAttached", f, void 0, g) : ni(g, f, a)
    } else c = {
        csn: b,
...
function lj(a, b, c, d, e) {
    ...
    P("il_via_jspb") ? (d = new ke, d.h(b), c = c.getAsJspb(), H(d, L, 2, c), F(d, 4, 1), e && H(d, ae, 3, e), "UNDEFINED_CSN" === b ? Y("visualElementShown", f, void 0, d) : ii(d, f, a)) : (e = {
        csn: b,
        ve: c.getAsJson(),
        eventType: 1
...
function mj(a, b, c) {
    ...
    if (P("il_via_jspb")) {
        ...
        H(e, L, 2, c);
        F(e, 4, 2);
        "UNDEFINED_CSN" === b ? Y("visualElementHidden", d, void 0, e) : ji(e, d, a)
    } else e = {
        csn: b,
        ve: c.getAsJson(),
        eventType: 2
    }, "UNDEFINED_CSN" === b ? Y("visualElementHidden", d, e) : a ? V("visualElementHidden", e, a, d) : W("visualElementHidden", e, d)
}
...
function nj(a, b, c, d, e) {
    ...
    P("il_via_jspb") ? (d = new ke, d.h(b), c = c.getAsJspb(), H(d, L, 2, c), F(d, 4, 4), e && H(d, ae, 3, e), "UNDEFINED_CSN" === b ? Y("visualElementShown", f, void 0, d) : ii(d, f, a)) : (e = {
        csn: b,
        ve: c.getAsJson(),
        eventType: 4
    }, d && (e.clientData = d), "UNDEFINED_CSN" === b ? Y("visualElementShown", f, e) : a ? V("visualElementShown", e, a, f) : W("visualElementShown", e, f))
...
function oj(a, b, c, d = !1) {
    ...
    P("il_via_jspb") ? (e = new je, e.h(b), c = c.getAsJspb(), H(e, L, 2, c), F(e, 4, d ? 16 : 8), "UNDEFINED_CSN" === b ? Y("visualElementHidden", f, void 0, e) : ji(e, f, a)) : (d = {
        csn: b,
        ve: c.getAsJson(),
        eventType: e
...
function pj(a, b, c, d) {
    ...
    P("il_via_jspb") ? (d = new ie, d.h(b), c = c.getAsJspb(), H(d, L, 2, c), F(d, 4, qe.INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK), "UNDEFINED_CSN" === b ? Y("visualElementGestured", e, void 0, d) : ki(d, e, a)) : (c = {
        csn: b,
        ve: c.getAsJson(),
...
function Ng(a) {
    if (fj) {
        for (const b of fj)
            if (P("il_via_jspb") && b.N) switch (b.N.h(a.csn), b.T) {
                case "screenCreated":
                    mi(b.N, b.options);
                    break;
                ...
                case "visualElementStateChanged":
                    ...
                    break;
                default:
                    Li(new Q("flushQueue unable to map payloadName to JSPB setter"))
            } else b.payload && (b.payload.csn =
                a.csn, V(b.T, b.payload, null, b.options));
        fj.length = 0
    }
    ij = 0
};
...
function wj(a, b) {
    P("use_ts_visibilitylogger") ? (qj(), a = !!(tj(a) & b)) : a = !!(vj(a) & b);
    return a
}

function xj(a, b) {
    if (P("use_ts_visibilitylogger")) {
        a = qj();
        var c = sj(0, b),
        ...
        if (c || b.visualElement)
            if (d = X(8)) {
                ...
                if (tj(b) || g) {
                    c = b.visualElement ? b.visualElement : Pi(c);
                    var h = b.i,
                        k = b.j;
                    g || e ? tj(b) & 4 ? f || nj(a.client, d, c, h, k) : tj(b) & 1 && !e && lj(a.client, d, c, h, k) : lj(a.client, d, c, h, k)
                }
            }
    } else if (c = uj(0, b), d = b.visualElement ? b.visualElement : c, e = a.o.has(d), f = a.i.get(d), a.o.add(d),
        a.i.set(d, !0), b.h && !e && b.h(), c || b.visualElement)
        if (d = X(8))
            if (g = !(!b.data || !b.data.loggingDirectives), vj(b) || g) c = b.visualElement ? b.visualElement : Pi(c), h = b.i, k = b.j, g || e ? wj(b, 4) ? f || nj(a.h, d, c, h, k) : wj(b, 1) && !e && lj(a.h, d, c, h, k) : lj(a.h, d, c, h, k)
}
...
function yj(a, b) {
    if (P("use_ts_visibilitylogger")) {
        ...
        a.i.add(d);
        a.h.set(d, !1);
        !1 !== f && (c || b.visualElement) && (!(d = X(8)) || !tj(b) && b.data && b.data.loggingDirectives || (c = b.visualElement ? b.visualElement : Pi(c), tj(b) & 8 ? oj(a.client, d, c) : tj(b) & 2 && !e && mj(a.client, d, c)))
    } else c = uj(0, b), d = b.visualElement ? b.visualElement : c, e = a.l.has(d), f = a.i.get(d), a.l.add(d), a.i.set(d, !1), !1 !== f && (c || b.visualElement) && (!(d = X(8)) || !vj(b) && b.data && b.data.loggingDirectives ||
...
class zj {
    ...
    j(a) {
        P("use_ts_visibilitylogger") ? qj().j(a) : this.h = a
    }
    clear() {
        P("use_ts_visibilitylogger") ? qj().clear() : (this.o.clear(), this.l.clear(), this.i.clear(), this.u = null)
    }
}(function() {
    var a = zj;
    a.ja = void 0;
...
var Aj = a => self.btoa(String.fromCharCode.apply(null, Array.from(new Uint8Array(a)))).replace(/\+/g, "-").replace(/\//g, "_");
var Bj = ["notifications_register", "notifications_check_registration"];
let Cj = null;
...
function Z(a, b) {
    ...
    c.key = a;
    c.value = b;
    return Dj().then(d => new Promise((e, f) => {
        try {
...
function Ej() {
    return Z("IndexedDBCheck", "testing IndexedDB").then(() => Fj("IndexedDBCheck")).then(a => "testing IndexedDB" === a ? Promise.resolve() : Promise.reject()).then(() => !0).catch(() => !1)
}

function Fj(a) {
    const b = new Q("Error accessing DB");
    return Dj().then(c => new Promise((d, e) => {
        try {
...
function Dj() {
    return Cj ? Promise.resolve(Cj) : new Promise((a, b) => {
        const c = self.indexedDB.open("swpushnotificationsdb");
        c.onerror = b;
        c.onsuccess = () => {
            const d = c.result;
            if (d.objectStoreNames.contains("swpushnotificationsstore")) Cj = d, a(Cj);
            else return self.indexedDB.deleteDatabase("swpushnotificationsdb"), Dj()
        };
...
var Nj = Lj.performance || Lj.mozPerformance || Lj.msPerformance || Lj.webkitPerformance || new Mj;
na(Nj.clearResourceTimings || Nj.webkitClearResourceTimings || Nj.mozClearResourceTimings || Nj.msClearResourceTimings || Nj.oClearResourceTimings || qa, Nj);
...
function Qj(a, b, c = {}) {
    ...
    a.l = () => {
        ...
        var d = aj(c.layer);
        if (d) {
            for (var e of a.u) Sj(a, e[0], e[1] || d, c.layer);
            for (const k of a.I) {
                e = X(0);
                var f = k[0] || aj(0);
                if (e && f) {
                    ...
                    var g = f,
                        h = k[1];
                    f = {
                        cttAuthInfo: dj(e) || void 0,
                        D: e
                    };
                    P("il_via_jspb") ? (h = new le, h.h(e), g = g.getAsJspb(), H(h, L, 2, g), "UNDEFINED_CSN" === e ? Y("visualElementStateChanged", f, void 0, h) : li(h, f, d)) : (g = {
                        csn: e,
                        ve: g.getAsJson(),
                        clientData: h
    ...
    X(c.layer) || a.l();
    if (c.ta)
        for (const d of c.ta) Tj(a, d, c.layer);
    else Ki(Error("Delayed screen needs a data promise."))
}

function Rj(a, b, c = {}) {
    c.layer || (c.layer = 0);
    var d = void 0 !== c.Va ? c.Va : c.layer;
    var e = X(d);
    d = aj(d);
    let f;
    ...
    let k;
    try {
        k = jj(a.client, b, f, c.sa, c.cttAuthInfo, g, c.Rb)
    } catch (l) {
        a = l;
        c = [{
            fc: b,
    ...
    ej(k, b, c.layer, c.cttAuthInfo);
    if (b = e && "UNDEFINED_CSN" !== e && d) {
        a: {
            for (const l of Object.values(Xi))
                if (X(l) === e) {
                    b = !0;
                    break a
                }
    ...
    d = zj.A();
    P("use_ts_visibilitylogger") ? (d = qj(), d.clear(), d.csn = X()) : (d.clear(), d.u = X());
    d = aj(c.layer);
    e && "UNDEFINED_CSN" !== e && d && (P("web_mark_root_visible") || P("music_web_mark_root_visible")) && lj(void 0, k, d);
    a.i.delete(c.layer || 0);
    a.l = void 0;
    for (const [l, m] of a.pa) e =
        l, m.has(c.layer) && d && Sj(a, e, d, c.layer);
...
function Uj(a) {
    ...
    [28631].includes(b) || (Li(new Q("createClientScreen() called with a non-page VE", b)), b = 83769);
...
function Tj(a, b, c = 0) {
    b.then(d => {
        ...
        if (e && f) {
            var g;
            (null == d ? 0 : null == (g = d.response) ? 0 : g.trackingParams) && kj(a.client, e, f, [Pi(d.response.trackingParams)]);
            var h;
            (null == d ? 0 : null == (h = d.playerResponse) ? 0 : h.trackingParams) && kj(a.client, e, f, [Pi(d.playerResponse.trackingParams)])
        }
    })
}

function Sj(a, b, c, d = 0) {
    if (a.i.has(d)) a.u.push([b, c]);
    else {
        var e = X(d);
        c = c || aj(d);
        e && c && kj(a.client, e, c, [b])
    }
}

function Vj(a, b, c = 0) {
    (c = X(c)) && pj(a.client, c, b)
}

function Wj(a, b, c, d = 0) {
    if (!b) return !1;
    d = X(d);
    if (!d) return !1;
    pj(a.client, d, Pi(b), c);
    return !0
}

function Xj(a, b) {
    const c = b.Oa && b.Oa();
    b.visualElement ? Vj(a, b.visualElement, c) : (b = uj(zj.A(), b), Wj(a, b, void 0, c))
}
var Pj = class {
    constructor() {
        this.u = [];
    ...
    clickCommand(a, b, c = 0) {
        return Wj(this, a.clickTrackingParams, b, c)
    }
};
...
var ck = class {
    ...
    j(a) {
        ...
        if (b) {
            const c = E(b, 5);
            c && (t.__SAPISID = c);
            null != E(b, 10) ? N("EOM_VISITOR_DATA", E(b, 10)) : null != E(b, 7) && N("VISITOR_DATA", E(b, 7));
            null != E(b, 4, !1) && N("SESSION_INDEX", String(E(b, 4)));
            null != E(b, 8) && N("DELEGATED_SESSION_ID", E(b, 8))
        }
        return a
    }
};
...
function ek(a) {
    const b = {};
    var c = Uc();
    c && (b.Authorization = c, c = a = null == a ? void 0 : a.sessionIndex, void 0 === c && (c = Number(O("SESSION_INDEX", 0)), c = isNaN(c) ? 0 : c), P("voice_search_auth_header_removal") || (b["X-Goog-AuthUser"] = c), "INNERTUBE_HOST_OVERRIDE" in De || (b["X-Origin"] = window.location.origin), void 0 === a && "DELEGATED_SESSION_ID" in De && (b["X-Goog-PageId"] = O("DELEGATED_SESSION_ID")));
    return b
}
var fk = class {
    constructor() {
...
function jk() {
    ...
    if (!a) return Ki(Error("Error: No InnerTubeContext shell provided in ytconfig.")), {};
    a = ya(a);
...
function ok(a, b, c) {
    ...
    c.push(b);
    if (d.Aa) var e = d.Aa;
    else if (d.hb) e = d[kk] ? pk(a, d[kk], c) : [], e = d.hb(...e);
    else if (d.gb) {
        e = d.gb;
        const f = e[kk] ? pk(a, e[kk], c) : [];
        e = new e(...f)
...
const vk = ["type.googleapis.com/youtube.api.pfiinnertube.YoutubeApiInnertube.BrowseResponse"];
...
function wk(a) {
    ...
    if (void 0 !== nk.h) {
        const d = nk.h;
        a = [b !== d.o, a !== d.l, c !== d.j, !1, !1, void 0 !== d.i];
...
function xk(a, b) {
    return r(function*() {
        var c, d = {
            sessionIndex: null == a ? void 0 : null == (c = a.ra) ? void 0 : c.sessionIndex
        };
        c = yield md(ek(d));
...
function zk(a, b, c) {
    return r(function*() {
        ...
        if (null == b ? 0 : null == (d = b.L) ? 0 : d.context)
            for (const m of []) m.bc(b.L.context);
        var e;
        if (null == (e = a.i) ? 0 : e.jc(b.input, b.L)) return yield a.i.Tb(b.input, b.L);
        var f;
        if ((d = null == (f = b.config) ? void 0 : f.ec) && a.h.has(d) && P("web_memoize_inflight_requests")) var g = a.h.get(d);
        else {
        ...
        var h;
        let k;
        if (P("web_one_platform_error_handling") && g && "error" in g && (null == (h = g) ? 0 : null == (k = h.error) ? 0 : k.details)) {
            h = g.error.details;
            for (const m of h)(h = m["@type"]) && -1 < vk.indexOf(h) && (delete m["@type"], g = m)
        }
        d && a.h.has(d) && a.h.delete(d);
        let l;
        !g && (null == (l = a.i) ? 0 : l.Nb(b.input, b.L)) && (g = yield a.i.Sb(b.input, b.L));
        return g || void 0
    })
}
...
function Ak(a, b, c) {
    ...
    b.context || (b.context = jk());
    return new J(e => r(function*() {
        var f = sk(c);
        f = We(f) ? "same-origin" : "cors";
        if (a.j.ab) {
            var g, h = null == d ? void 0 : null == (g = d.ra) ? void 0 : g.sessionIndex;
            g = ek({
                sessionIndex: h
            });
            f = Object.assign({}, yk(f), g)
        } else f = yield xk(d, f);
        g = sk(c);
        h = {};
...
function yk(a) {
    ...
    P("track_webfe_innertube_auth_mismatch") && (b["X-Youtube-Bootstrap-Logged-In"] = O("LOGGED_IN", !1));
    "cors" !== a && ((a = O("INNERTUBE_CONTEXT_CLIENT_NAME")) && (b["X-Youtube-Client-Name"] = a), (a = O("INNERTUBE_CONTEXT_CLIENT_VERSION")) && (b["X-Youtube-Client-Version"] = a), (a = O("CHROME_CONNECTED_HEADER")) && (b["X-Youtube-Chrome-Connected"] =
        a), (a = O("DOMAIN_ADMIN_STATE")) && (b["X-Youtube-Domain-Admin-State"] = a));
    return b
}
var nk = class {
    constructor(a, b, c) {
...
function Ck() {
    if (!Bk) {
        ...
        var a = rk;
        wk({
            fetch: (b, c) => md(fetch(new Request(b, c)))
        });
        lk(a);
        Bk = a.resolve(mk)
    }
...
function Jk(a) {
    ...
    a = b.type;
    b = b.data;
    "notifications_register" === a ? (Z("IDToken", b), Kk()) : "notifications_check_registration" === a && Lk(b)
}
...
function Ok(a) {
    return r(function*() {
        const b = Nk(a.payload.chrome.extraUrlParams),
            c = {
            ...
            d = Jj(xe);
        return Pk().then(e => Ak(e, c, d).then(f => {
            f.json().then(g => g && g.endpointUrl ? Qk(a, g.endpointUrl) : Promise.resolve()).catch(g => {
                Fk(g);
                Promise.reject(g)
            })
        }))
...
function Rk(a, b) {
    ...
    a = Ik.test(a) ? new URL(a) : new URL(a, self.registration.scope);
...
function Qk(a, b) {
    ...
    return self.registration.showNotification(e, g).then(() => {
        var h;
        (null == (h = g.data) ? 0 : h.postedEndpoint) && Sk(g.data.postedEndpoint);
        let k;
        if (null == (k = g.data) ? 0 : k.clickTrackingParams) h = Pi(g.data.clickTrackingParams), Sj(d, h, void 0, 8), h = {
            ea: 8,
            visualElement: h
        }, xj(zj.A(), h);
        Tk(a.displayCap)
...
function Sk(a) {
    if (!Kj(a)) return Promise.reject();
    const b = {
            serializedRecordNotificationInteractionsRequest: Kj(a).serializedInteractionsRequest
        },
        c = Jj(ye);
    return Pk().then(d => Ak(d, b, c)).then(d => d)
}
    ...
    -1 !== a && self.registration.getNotifications().then(b => {
        for (let d = 0; d < b.length - a; d++) {
            ...
            if (null == (e = b[d].data) ? 0 : e.clickTrackingParams) {
                let f;
                var c = Pi(null == (f = b[d].data) ? void 0 : f.clickTrackingParams);
                const g = {
                        ea: 8,
                        visualElement: c
                    },
...
function Lk(a) {
    const b = [Uk(a), Fj("RegistrationTimestamp").then(Vk), Wk(), Xk(), Yk()];
    Promise.all(b).catch(() => {
        Z("IDToken", a);
        Kk();
...
function Uk(a) {
    return Fj("IDToken").then(b => a === b ? Promise.resolve() : Promise.reject())
}

function Wk() {
    return Fj("Permission").then(a => Notification.permission === a ? Promise.resolve() : Promise.reject())
}

function Xk() {
    return Fj("Endpoint").then(a => Zk().then(b => a === b ? Promise.resolve() : Promise.reject()))
}

function Yk() {
    return Fj("application_server_key").then(a => $k().then(b => a === b ? Promise.resolve() : Promise.reject()))
}
...
function Kk() {
    ...
    Promise.all([Zk(), bl(), cl(), $k()]).then(([a, b, c, d]) => {
        b = b ? Aj(b) : null;
        c = c ? Aj(c) : null;
        d = d ? Va(new Uint8Array(d), 4) : null;
        dl(a, b, c, d)
    }).catch(() => {
        dl()
    })
...
function dl(a = null, b = null, c = null, d = null) {
    Ej().then(e => {
        e && (Z("Endpoint", a), Z("P256dhKey", b), Z("AuthKey", c), Z("application_server_key", d), Z("Permission", Notification.permission), Promise.all([Fj("DeviceId"), Fj("NotificationsDisabled")]).then(([f, g]) => {
            if (null != f) var h = f;
            else {
                f = [];
                var k;
                h = h || zd.length;
                for (k = 0; 256 > k; k++) f[k] = zd[0 | Math.random() * h];
                h = f.join("")
            }
            el(h, null != a ? a : void 0, null != b ? b : void 0, null != c ? c : void 0, null != d ? d : void 0, null != g ? g : void 0)
        }))
    })
}
...
function el(a, b, c, d, e, f) {
    r(function*() {
        const g = {
            ...
            h = Jj(ze);
        return Pk().then(k => Ak(k, g, h).then(() => {
            Z("DeviceId", a);
...
function Pk() {
    return r(function*() {
        try {
            return yield bk(!0), Ck()
        } catch (a) {
            return yield Dk(a), Promise.reject(a)
        }
    })
};
let fl = self.location.origin + "/";

function dk(a) {
    let b = "undefined" !== typeof ServiceWorkerGlobalScope && self instanceof ServiceWorkerGlobalScope ? Wc.registration.scope : fl;
...
function hl(a) {
    return r(function*() {
        gl || (gl = yield a.open("yt-appshell-assets"));
        return gl
    })
}
...
function il(a, b) {
    return r(function*() {
        const c = yield hl(a), d = b.map(e => jl(c, e));
...
function ll(a, b) {
    return r(function*() {
        const c = yield hl(a), d = (yield c.keys()).filter(e => !b.includes(e.url)).map(e => c.delete(e));
        return Promise.all(d)
    })
}
...
function ml(a, b, c) {
    return r(function*() {
        yield(yield hl(a)).put(b, c)
    })
}

function nl(a, b) {
    r(function*() {
        yield(yield hl(a)).delete(b)
    })
}
...
var ol;
ol = rg("yt-serviceworker-metadata", {
    S: {
        auth: {
            X: 1
        },
    ...
    ma: !0,
    upgrade(a, b) {
        b(1) && Mf(a, "resource-manifest-assets");
        b(2) && Mf(a, "auth")
    },
    version: 2
});
...
function rl(a, b) {
    return r(function*() {
        yield If(yield ql(a.token), ["resource-manifest-assets"], "readwrite", c => {
...
function sl(a, b) {
    return r(function*() {
        let c = !1,
            d = 0;
        yield If(yield ql(a.token), ["resource-manifest-assets"], "readonly", e => Rf(e.objectStore("resource-manifest-assets"), {
            query: IDBKeyRange.bound(0, Date.now()),
            direction: "prev"
        }, f => {
            if (f.ha().includes(b)) c = !0;
...
function tl(a) {
    return r(function*() {
        pl || (yield If(yield ql(a.token), ["resource-manifest-assets"], "readonly", b => Rf(b.objectStore("resource-manifest-assets"), {
            query: IDBKeyRange.bound(0, Date.now()),
            direction: "prev"
        }, c => {
            pl = c.getKey()
...
var ul = class {
    ...
    static A() {
        return r(function*() {
            const a = yield kg();
            if (a) return ul.h || (ul.h = new ul(a)), ul.h
        })
    }
};
...
function vl(a, b) {
    return r(function*() {
        yield Of(yield ql(a.token), "auth", b, "shell_identifier_key")
    })
}

function wl(a) {
    return r(function*() {
        return (yield(yield ql(a.token)).get("auth", "shell_identifier_key")) || ""
    })
}

function xl(a) {
    return r(function*() {
        yield(yield ql(a.token)).clear("auth")
    })
}
var yl = class {
    constructor(a) {
...
function Bl(a) {
    a: {
        ...
        try {
            const e = pc(b);
            var d = qc(new e.ga, a, e);
            break a
        } finally {
            b = a, b.h.clear(), b.l = -1, b.i = -1, 100 > lc.length && lc.push(b)
        }
        d = void 0
    }
    return d
...
function El(a) {
    return r(function*() {
        ...
        return b ? Promise.resolve(Fl(b)) : Promise.reject(Error("No resource manifest header"))
    })
}

function Fl(a) {
    return Lb(Bl(decodeURIComponent(a)), Al, 1).reduce((b, c) => {
        (c = E(c, 1)) && b.push(c);
        return b
    }, [])
};
...
function Gl(a) {
    return r(function*() {
        ...
        if (b && null != E(b, 3)) {
            var c = yield yl.A();
            c && (c = yield wl(c), E(b, 3) !== c && (nl(a.caches, a.h), zl()))
        }
    })
}
...
function Hl(a) {
    return r(function*() {
        let b, c;
        try {
            c = yield Il(a.i), b = yield El(c), yield il(a.caches, b)
        } catch (d) {
            return Promise.reject(d)
        }
        try {
            yield Jl(), yield ml(a.caches, a.h, c)
        } catch (d) {
            return Promise.reject(d)
        }
        if (b) try {
...
function Jl() {
    return r(function*() {
        ...
        return b ? (a = yield yl.A()) ? Promise.resolve(vl(a, b)) : Promise.reject(Error("Could not get AuthMonitor instance")) : Promise.reject(Error("Could not get datasync ID"))
    })
}
...
function Ml(a, b) {
    return r(function*() {
        return kl(a.caches, b)
    })
}

function Nl(a) {
    return r(function*() {
        return kl(a.caches, a.h)
    })
}
var Ol = class {
    constructor() {
...
function Tl(a, b) {
    return r(function*() {
        ...
        const d = yield Nl(a.h);
        if (d) return Vl(a), Wl(d, b);
        Xl(a);
...
function Zl(a, b) {
    return r(function*() {
        const c = yield Nl(a.h);
        if (!c) return Xl(a), Sl(b);
        Vl(a);
        var d;
        a: {
        ...
        if (!(-1 < d && 7 <= d / 864E5)) return Wl(c, b);
        d = yield Ul(b);
        return d.response && d.response.ok ? d.response : Wl(c, b)
    })
}

function Sl(a) {
    return Promise.resolve(a.preloadResponse).then(b => b && !$l(b) ? b : t.fetch(a.request))
}
...
function Wl(a, b) {
    ...
    Promise.resolve(b.preloadResponse).then(e => {
        if (!e || !$l(e)) throw Error("no pbj preload response available");
...
var im = class {
    constructor() {
        ...
        var b = {
            Ka: bm,
            Xa: cm([dm, /\/signin/, /\/logout/]),
            qa: ["/", "/feed/downloads"],
            Ia: em([{
                key: "feature",
                value: "ytca"
            }]),
            Ha: fm(P("kevlar_sw_app_wide_fallback") ? gm : hm)
        };
        this.h = a;
        this.config = b
    }
...
const jm = /^\/$/,
    hm = [jm, /^\/feed\/downloads$/],
    gm = [jm, /^\/feed\/\w*/, /^\/results$/, /^\/playlist$/, /^\/watch$/, /^\/channel\/\w*/];

function fm(a) {
    return new RegExp(a.map(b => b.source).join("|"))
}
const km = /^https:\/\/([\w-]*\.)*youtube\.com.*/;

function cm(a) {
    a = fm(a);
    return new RegExp(`${km.source}(${a.source})`)
}
const lm = fm([/\.css$/, /\.js$/, /\.ico$/, /\/ytmweb\/_\/js\//, /\/ytmweb\/_\/ss\//, /\/kabuki\/_\/js\//, /\/kabuki\/_\/ss\//, /\/ytmainappweb\/_\/ss\//]),
    bm = new RegExp(`${km.source}(${lm.source})`),
    dm = /purge_shell=1/;

function em(a = []) {
    const b = [];
    for (const c of Lc) b.push({
        key: c
    });
...
var nm = class {
    ...
    l(a) {
        ...
        return r(function*() {
            ...
            const e = a.request;
            if (c.config.Xa.test(e.url)) ck.h && (delete ck.h.h, t.__SAPISID = void 0, N("VISITOR_DATA", void 0), N("SESSION_INDEX", void 0), N("DELEGATED_SESSION_ID", void 0)), d = a.respondWith,
                c = c.h, nl(c.caches, c.h), zl(), c = Sl(a), d.call(a, c);
            else if (c.config.Ka.test(e.url)) a.respondWith(Ql(c, a));
            else if ("navigate" === e.mode) {
                const f = new URL(e.url),
                    g = c.config.qa;
                (!P("sw_nav_request_network_first") && g.includes(f.pathname) ? 0 : c.config.Ha.test(f.pathname)) ? a.respondWith(Tl(c, a)): Yl(c, e.url) ? a.respondWith(Zl(c, a)) : d && a.respondWith(Sl(a))
            }
        })
    }
    C(a) {
        const b = a.data;
        this.I.includes(b.type) ? Jk(a) : "refresh_shell" === b.type && Hl(this.i).catch(c => {
            Dk(c)
        })
    }
};
var om = class {
    static A() {
        ...
        a || (a = new om, v("ytglobal.storage_", a));
        return a
    }
    estimate() {
        return r(function*() {
            ...
            let c;
            if (null == (c = a.webkitTemporaryStorage) ? 0 : c.queryUsageAndQuota) return pm()
        })
    }
};
...
v("ytglobal.storageClass_", om);

function qm(a, b) {
    om.A().estimate().then(c => {
        c = Object.assign({}, b, {
            isSw: void 0 === self.document,
            isIframe: self !== self.top,
            deviceStorageUsageMbytes: rm(null == c ? void 0 : c.usage),
            deviceStorageQuotaMbytes: rm(null == c ? void 0 : c.quota)
        });
...
class sm {
    constructor() {
        ...
        this.j = Math.random() <= He("ytidb_transaction_ended_event_rate_limit_session", .2)
    }
    aa(a, b) {
        switch (a) {
            ...
            case "TRANSACTION_ENDED":
                this.j && Math.random() <= He("ytidb_transaction_ended_event_rate_limit_transaction",
...
for (jf = new sm; 0 < hf.length;) {
    const a = hf.shift();
    switch (a.type) {
        case "ERROR":
            jf.handleError(a.payload);
            break;
        case "EVENT":
            jf.aa(a.eventType, a.payload)
    }
}
ck.h = new ck;
...
self.onpush = function(a) {
    a.waitUntil(Fj("NotificationsDisabled").then(b => {
        if (b) return Promise.resolve();
        if (a.data && a.data.text().length) try {
            return Ok(a.data.json())
        } catch (c) {
